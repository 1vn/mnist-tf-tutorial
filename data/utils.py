...
# URLs for WMT data.
_WMT_ENFR_TRAIN_URL = "http://www.statmt.org/wmt15/training-parallel-nc-v10.tgz"
...
def get_wmt_enfr_train_set(directory):
  ...
  train_path = os.path.join(directory, "news-commentary-v10.fr-en")
  if not (gfile.Exists(train_path + ".fr") and
          gfile.Exists(train_path + ".en")):
    corpus_file = maybe_download(directory, "training-parallel-nc-v10.tgz",
                                 _WMT_ENFR_TRAIN_URL)
...
def prepare_wmt_data(data_dir,
  ...
  return prepare_data(data_dir, from_train_path, to_train_path, from_dev_path,
                      to_dev_path, en_vocabulary_size, fr_vocabulary_size,
                      tokenizer)
